...
export default class App extends Component {
  ...
  render() {
    return this.state.loading === true ? <h1>Loading</h1> : (
      <BrowserRouter>
        <div>
          <nav className="navbar navbar-default navbar-static-top" style={{margin: 0}}>
            <div className="container">
              <div className="navbar-header">
                <Link to="/" className="navbar-brand" style={{color: 'white'}}>Barcamp</Link>
              </div>
              <ul className="nav navbar-nav pull-right">
                ...
                <li>
                  <Link to="/dashboard" className="navbar-brand" style={{color: 'white'}}>Dashboard</Link>
                </li>
                <li>
                  {this.state.authed
                    ? <button
